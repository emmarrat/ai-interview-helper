...
export const MESSAGE_ASK_REVIEW = (position: string, interview: string) => {
    return `Представь что я прохожу у тебя интервью на позицию ${position}. Рассмотри следующий массив с обьектами где question это твой вопрос, а answer это мой ответ: ${interview}. Напиши свою оценку на каждый данный мной ответ и верни массив такого вида {question: предоставленный вопрос, answer: предоставленный ответ, review: твое оценночное мнение относительно ответа, id: число }`;
};
